      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">How can I become an artisan partner?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  We're always looking for talented artisans. Please send us samples of your work along with your contact information.
                </p>
              </CardContent>
            </Card>
          </div>
